define([
  ...
  CodeMirror.Vim.mapCommand(
    "<Plug>(visual-vim-binding-k)", "motion", "moveByLinesOrCell",
    {forward: false, linewise: true },
    {context: "visual"}
  );
  CodeMirror.Vim.mapCommand(
    "<Plug>(visual-vim-binding-j)", "motion", "moveByLinesOrCell",
    {forward: true, linewise: true },
    {context: "visual"}
  );
  CodeMirror.Vim.mapCommand(
    "<Plug>(visual-vim-binding-gk)", "motion", "moveByDisplayLinesOrCell",
    {forward: false },
    {context: "visual"}
  );
  CodeMirror.Vim.mapCommand(
    "<Plug>(visual-vim-binding-gj)", "motion", "moveByDisplayLinesOrCell",
    {forward: true },
    {context: "visual"}
  );
  ...
  CodeMirror.Vim.map('k', '<Plug>(visual-vim-binding-k)', 'visual');
  CodeMirror.Vim.map('j', '<Plug>(visual-vim-binding-j)', 'visual');
  CodeMirror.Vim.map('gk', '<Plug>(visual-vim-binding-gk)', 'visual');
  CodeMirror.Vim.map('gj', '<Plug>(visual-vim-binding-gj)', 'visual');

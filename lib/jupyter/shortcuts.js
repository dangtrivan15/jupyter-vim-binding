define([
  ...
  exports.get_default_command_shortcuts = function get_default_command_shortcuts() {
    return {
      ...
      'z,f': 'vim-binding-normal:collapse-output',
      'z,shift-f': 'vim-binding-normal:collapse-all-output',
      'z,o': 'vim-binding-normal:expand-output',
      'z,shift-o': 'vim-binding-normal:expand-all-output',
